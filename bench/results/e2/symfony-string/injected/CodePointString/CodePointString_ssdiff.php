...
class CodePointString extends AbstractUnicodeString
{
    ...
    public function chunk(string $length = 1): array
    {
        if (1 > $length) {
    ...
    public function codePointsAt(string $offset): array
    {
    ...
    public function indexOf(string|iterable|AbstractString $needle, string $offset = 0): ?string
    {
    ...
    public function indexOfLast(string|iterable|AbstractString $needle, string $offset = 0): ?string
    {
        if ($needle instanceof AbstractString) {
            $needle = $needle->string;
        } elseif (!\is_string($needle)) {
    ...
    public function slice(string $start = 0, ?string $length = null): static
    {
        $str = clone $this;
    ...
    public function splice(string $replacement, string $start = 0, ?string $length = null): static
    {
    ...
    public function split(string $delimiter, ?string $limit = null, ?string $flags = null): array
    {
